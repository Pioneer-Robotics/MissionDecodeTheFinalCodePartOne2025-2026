...
@Autonomous(name = "Audience Side Auto (Logging)", group = "Autonomous")
class AudienceSideAuto_WithLogging : BaseOpMode() {
    ...
    override fun onInit() {
        ...
        odometryLogger = OdometryLogger(bot, "AudienceSideAuto")
    }
    ...
    override fun onStart() {
        ...
        odometryLogger.logCheckpoint("AUTO_START", P.START_FAR)
    }
    ...
    private fun state_goto_shoot() {
        ...
        if (bot.follower.done) { // Ending path
            ...
            odometryLogger.logCheckpoint("END_PATH_TO_SHOOT", P.SHOOT_GOAL_FAR)
